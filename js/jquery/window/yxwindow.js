...
$.Window = (function()  {
	...
	function constructor(caller, options) {
		...
		function initialize(instance) {
			...
			realCaller.append("<div style='z-index:9999' id='"+windowId+"' class='window_panel "+cornerClass+options.containerClass+"'></div>");
			...
			if( options.url != null && $.trim(options.url) != "" ) {
				...
				container.append("<iframe style='display:none;' class='window_frame  no-draggable no-resizable "+options.frameClass+"' scrolling='"+scrollingHtml+"' src='"+options.url+"' width='100%' height='"+frameHeight+"px' frameborder='0'></iframe>");
				...
				container.append("<div class='window_frame  no-draggable no-resizable "+options.frameClass+"' style='width:100%; height:"+frameHeight+"px;'></div>");
				frame = container.children(".window_frame");
			...
			if( options.showFooter ) {
				...
				container.append("<div class='window_footer  "+cornerClass+"no-draggable no-resizable "+options.footerClass+"'><div></div></div>");
