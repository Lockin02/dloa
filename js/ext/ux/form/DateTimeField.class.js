...
Ext.reg('datetimepickerfield', Ext.ux.DateTimePicker);
if (parseInt(Ext.version.substr(0, 1), 10) > 2) {
//ext 3.0    
    Ext.menu.DateTimeItem = Ext.ux.DateTimePicker;
...
//ext 2.0 below
    ...
    Ext.menu.DateTimeItem = function(config){
        Ext.menu.DateTimeItem.superclass.constructor.call(this, new Ext.ux.DateTimePicker(config), config);
