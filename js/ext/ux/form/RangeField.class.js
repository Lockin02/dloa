...
$package("Ext.ux.form");
Ext.ux.form.RangeField = Ext.extend(Ext.form.Field, {
			...
			initComponent : function() {
				Ext.ux.form.RangeField.superclass.initComponent.call(this);
				...
				switch (type.toLowerCase()) {
					case "numberfield" :
						...
						Ext.apply(numberfieldCfg, defCfg1);
						this.c1 = new Ext.form.NumberField(numberfieldCfg);
						Ext.apply(numberfieldCfg, defCfg2);
					...
					case "combo" :
						...
						Ext.apply(comboCfg, defCfg1);
						this.c1 = new Ext.form.ComboBox(comboCfg);
						Ext.apply(comboCfg, defCfg2);
					...
					case "datefield" :
						...
						Ext.apply(dateCfg, defCfg1);
						this.c1 = new Ext.form.DateField(dateCfg);
						Ext.apply(dateCfg, defCfg2);
				...
				if (this.myForm) {
					this.myForm.form.items.add(this.c1);
					this.myForm.form.items.add(this.c2);
				}
			...
			// private
			initEvents : function() {
				Ext.ux.form.RangeField.superclass.initEvents.call(this);
			},

			// private
			onRender : function(ct, position) {
				Ext.ux.form.RangeField.superclass.onRender.call(this, ct,
						position);
			...
			onResize : function(w, h) {
				Ext.ux.form.RangeField.superclass.onResize.apply(this,
						arguments);
				if (this.wrap) {
			...
			// private
			onEnable : function() {
				Ext.ux.form.RangeField.superclass.onEnable.call(this);
			...
			// private
			onDisable : function() {
				Ext.ux.form.RangeField.superclass.onDisable.call(this);
				this.c1.setDisabled(this.disabled);
				this.c2.setDisabled(this.disabled);
			},
			// private
			onDestroy : function() {
				...
				Ext.ux.form.RangeField.superclass.onDestroy.call(this);
			},
			...
			setDisabled : function(v) {
				Ext.ux.form.RangeField.superclass.setDisabled.call(this);
