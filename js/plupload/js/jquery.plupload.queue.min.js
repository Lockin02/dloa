               ...
               // c("span.plupload_upload_status",i).text("Uploaded "+j.total.uploaded+"/"+j.files.length+" files")
                ...
                c.each(j.files,function(p,o){
                    ...
                    if(o.status==plupload.DONE){
                        ...
                        m.append('<li id="'+o.id+'"><div class="plupload_file_name"><span>'+o.name+'</span></div><div class="plupload_file_action"><a href="#"></a><a id="cleardel" href="#"></a></div><div class="plupload_file_status">'+o.percent+'%</div><div class="plupload_file_size">'+plupload.formatSize(o.size)+'</div><div class="plupload_clearer">&nbsp;</div>'+l+"</li>");
                    h(o);
					/*
					...
					*/
					  c("#"+o.id+" #cleardel").click(function(q){
					  c("#"+o.id).remove();
					  j.removeFile(o);
					  q.preventDefault()
					  })
