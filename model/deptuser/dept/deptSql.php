<?php
$sql_arr = array(
	"select" => "select 'dept' as icon,'dept' as type,c.Code,c.DEPT_ID as id,c.Depart_x,c.levelflag,c.PARENT_ID,c.pId,
	...
	"select_com" => "select 'dept' as icon,'dept' as type ,c.nameCN as DEPT_NAME ,c.comCode , '1' as levelflag from company c where 1=1 "
...
$condition_arr = array(
	...
	array(
		"name" => "unDeptFilter",
		"sql" => "and ( c.DEPT_ID not in ($) and c.PARENT_ID not in($) )"
	),
	array(
		"name" => "deptName",
