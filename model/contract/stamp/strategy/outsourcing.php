 ...
 * 销售开票申请策略
 */
class model_contract_stamp_strategy_outsourcing extends model_base implements istamp{
	...
	function initStamp_i($obj){
		...
		$innerObj['outsourceType'] = $datadictDao->getDataNameByCode($innerObj['outsourceType']);
//		$innerObj['stampType'] = $datadictDao->getDataNameByCode($innerObj['stampType']);
		...
		//签收状态
		$innerObj['signedStatusCN'] = $innerObjDao->rtIsSign_d($innerObj['signedStatus']);
