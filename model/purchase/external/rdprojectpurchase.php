...
class model_purchase_external_rdprojectpurchase extends planBasic {

	private $externalDao; //外部对象dao接口
	private $externalEquDao; //外部对象设备dao接口

	function __construct() {
		$this->externalDao = new model_rdproject_yxrdproject_rdproject();
		$this->externalEquDao = new model_rdproject_yxrdproject_rdprojectequ();
					...
					<tr><td>$j</td>
						...
						<td>
							<input type="text" id="remark" name="basic[equipment][$j][remark]" class='txt'/>
								...
								<input type="hidden" id="purchType$j" name="basic[equipment][$j][purchType]" value="oa_sale_rdproject" />
						</td>
						<td>
