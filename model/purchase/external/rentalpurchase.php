...
class model_purchase_external_rentalpurchase extends planBasic {

	private $externalDao; //外部对象dao接口
	private $externalEquDao; //外部对象设备dao接口

	function __construct() {
		$this->externalDao = new model_contract_rental_rentalcontract();
		$this->externalEquDao = new model_contract_rental_tentalcontractequ();
					...
					<tr><td>$j</td>
						...
						<td>
							<input type="text" id="remark" name="basic[equipment][$j][remark]" class='txt'/>
								...
								<input type="hidden" id="purchType$j" name="basic[equipment][$j][purchType]" value="oa_sale_lease" />
						</td>
						<td>
