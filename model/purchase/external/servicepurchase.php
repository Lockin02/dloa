...
class model_purchase_external_servicepurchase extends planBasic {

	private $externalDao; //外部对象dao接口
	private $externalEquDao; //外部对象设备dao接口

	function __construct() {
		$this->externalDao = new model_engineering_serviceContract_serviceContract();
		$this->externalEquDao = new model_engineering_serviceContract_serviceequ();
				...
				$str .= <<<EOT
					<tr><td>$j</td>
						...
						<td>
								...
								<input type="hidden" id="purchType$j" name="basic[equipment][$j][purchType]" value="oa_sale_service" />
						</td>
						<td>
