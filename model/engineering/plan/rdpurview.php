 ...
 * 计划权限
 */
class model_engineering_plan_rdpurview extends model_base{

	function __construct() {
		$this->tbl_name = "oa_rd_plan_purview";
		$this->sql_map = "engineering/plan/rdpurviewSql.php";
		parent::__construct ();
	}
...
EOT;
	 ...
	 */
	function addGroup($projectId,$planId){
		$projectDao = new model_engineering_project_engineering();
		$projectRows = $projectDao->rpManageUserById_d($projectId);
//		print_r($projectRows);

		$memberDao = new model_engineering_team_rdmember();
