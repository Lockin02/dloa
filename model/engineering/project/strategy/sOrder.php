 ...
 * 试用项目策略
 */
class model_engineering_project_strategy_sOrder extends model_base implements iesmproject{
...
//		}
	...
	function businessForCharter_i($obj,$mainDao){
		...
		$contractArr['contractType'] = 'GCXMYD-03';
    	$contractArr['cusName'] = $contractArr['customerName'];
    	$contractArr['cusNameId'] = $contractArr['customerId'];
    	$contractArr['beginDate'] = "";
    	$contractArr['endDate'] = "";
