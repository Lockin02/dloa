...
class model_stock_productinfo_importProductUtil extends model_base {
	...
	public static function exportIntimeListExcel($dataArr) {
		...
		foreach($dataArr as $k => $v){
			$n = $k + 2;
			$excelActiveSheet->setCellValueByColumnAndRow ( 0, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['stockName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 1, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['proType'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 2, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['productCode'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 3, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['productName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 4, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['actNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 5, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['exeNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 6, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['lockedNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 7, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['initialNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 8, $n, iconv ( "GBK", "utf-8", $dataArr [$k] ['auditNum'] ) );
		}
		$objWriter = new PHPExcel_Writer_Excel5 ( $objPHPExcel );
		//到浏览器
		ob_end_clean ();
	...
	public static function exportProductExcel($dataArr) {
		...
		for($n = 0; $n < count ( $dataArr ); $n ++) {
			...
			$excelActiveSheet->setCellValueByColumnAndRow ( 3, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['relProductCode'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 4, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['relProductName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 5, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['unitName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 6, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['pattern'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 7, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['ext1Status'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 8, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['warranty'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 9, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['arrivalPeriod'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 10, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['purchPeriod'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 11, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['purchUserName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 12, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['brand'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 13, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['packageInfo'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 14, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['material'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 15, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['color'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 16, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['leastPackNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 17, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['leastOrderNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 18, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['statTypeName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 19, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['supplier'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 20, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['remark'] ) );
			$excelActiveSheet->setCellValueExplicitByColumnAndRow ( 21, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['ext2'] ) ,PHPExcel_Cell_DataType::TYPE_STRING );
			$excelActiveSheet->setCellValueByColumnAndRow ( 22, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['priceLock'] ) );
		}
//
		$objWriter = new PHPExcel_Writer_Excel5 ( $objPHPExcel );
		//到浏览器
	...
	public static function exportOutStockExcel($dataArr) {
		...
		$excelActiveSheet = $objPHPExcel->getActiveSheet ();
		for($n = 0; $n < count ( $dataArr ); $n ++) {
			$excelActiveSheet->setCellValueByColumnAndRow ( 0, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['moduleName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 1, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['auditDate'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 2, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['docCode'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 3, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['isRed'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 4, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['relDocType'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 5, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['relDocCode'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 6, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['contractName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 7, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['contractCode'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 8, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['customerName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 9, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['productCode'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 10, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['productName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 11, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['pattern'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 12, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['unitName'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 13, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['actOutNum'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 14, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['cost'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 15, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['subCost'] ) );
			$excelActiveSheet->setCellValueByColumnAndRow ( 16, $n + 2, iconv ( "GBK", "utf-8", $dataArr [$n] ['remark'] ) );
