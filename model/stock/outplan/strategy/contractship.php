 ...
 * @description:销售发货单策略
 */
class model_stock_outplan_strategy_contractship implements shipStrategy
{
    ...
    function showItemAddByPlan($rows)
    {
        ...
        if (is_array($rows)) {
            ...
            foreach ($rows as $key => $val) {
                $contNumArr = $contProDao->getEquInfo($rows[$key]['contEquId'], 'oa_contract_contract');
