 ...
 * @version 1.0
 * @description:人事管理-基础信息-工作经历 Model层
 */
 class model_hr_personnel_work  extends model_base {
	...
	function excelOut($rowdatas){
		...
		$objPhpExcelFile = $objReader->load ( "upfile/人资-工作经历导入模板.xls" ); //读取模板
		//Excel2003及以前的格式
		...
		header ( 'Content-Disposition:inline;filename="' . "工作经历导出报表.xls" . '"' );
