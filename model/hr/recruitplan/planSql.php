...
$condition_arr = array (
	...
	array(
		"name" => "hopeDate",
		"sql" => " and c.hopeDate LIKE BINARY CONCAT('%',#,'%') "
	),
	array(
		"name" => "wageRange",
		"sql" => " and c.wageRange=# "
	...
	array(
		"name" => "entryNum",
		"sql" => " and c.entryNum LIKE CONCAT('%',#,'%') "
	),
	array(
		"name" => "beEntryNum",
		"sql" => " and c.beEntryNum LIKE CONCAT('%',#,'%') "
	),
	array(
		"name" => "recruitManId",
