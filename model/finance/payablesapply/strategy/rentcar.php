...
class model_finance_payablesapply_strategy_rentcar extends model_base implements ipayablesapply{
			...
			foreach($object['detail'] as $key => $val){
				...
				$str .=<<<EOT
					<tr>
						...
						<td>
							<input type="text" name="payablesapply[detail][$i][expand1]" id="expand1$i" value="$val[rentUnitPrice]" class="readOnlyTxtMiddle" readonly="readonly"/>
							<input type="hidden" name="payablesapply[detail][$i][expand2]" id="expand2$i" value="$val[oilPrice]" class="readOnlyTxtMiddle" readonly="readonly"/>
