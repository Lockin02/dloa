 ...
 */
$sql_arr = array (
	'select_default' => "select c.id ,c.payApplyId ,c.payApplyNo ,c.formNo ,c.formDate ,c.financeDate ,c.supplierName 
    ,c.supplierId ,c.payType ,c.payNo ,c.bank ,c.certificate ,c.amount ,c.deptId ,c.deptName 
    ,c.salesman ,c.status ,c.ExaStatus ,c.ExaDT ,c.createName ,c.createTime ,c.updateTime,c.belongId  
  from oa_finance_payables c 
	...
	'select_history' => "select c.id ,c.payApplyId ,c.formType,c.payApplyNo ,c.formNo ,c.formDate ,c.financeDate ,c.supplierName ," .
		"c.payType ,c.payNo ,c.bank ,c.certificate ,c.amount ,c.deptId ,c.deptName ,c.salesman ,c.status ,c.ExaStatus ,c.ExaDT ,c.createName ,c.createTime ,c.updateTime,d.money " .
	...
	'select_historyNew' => "select c.id ,c.payApplyId ,c.formType,c.payApplyNo ,c.formNo ,c.formDate ,c.financeDate ,c.supplierName ," .
		"c.payType ,c.payNo ,c.bank ,c.certificate ,c.amount ,c.deptId ,c.deptName ,c.salesman ,c.status ,c.ExaStatus ,c.ExaDT ,c.createName ,c.createTime ,c.updateTime,sum(d.money) as money " .
		"from oa_finance_payables c left join oa_finance_payables_detail d on c.id = d.advancesId ",
