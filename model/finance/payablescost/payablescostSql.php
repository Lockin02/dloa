 ...
 */
$sql_arr = array (
	"select_default" => "select c.id ,c.payapplyId ,c.payapplyCode ,c.shareTypeName ,c.shareType ,c.shareObjName,c.shareObjCode,c.shareObjId,c.deptName ,c.deptId ,c.userName ,c.userId ,c.projectName ,c.projectCode ,c.projectId ,c.status ,c.createId ,c.createName ,c.createTime ,c.updateId ,c.updateName ,c.updateTime ,c.sysCompanyName ,c.sysCompanyId,c.shareMoney,c.feeType,c.feeTypeId  from oa_finance_payablesapply_cost c where 1=1 ",
	"count_all" => "select sum(c.shareMoney) as shareMoney  from oa_finance_payablesapply_cost c where 1=1 ",
	"count_shareObj" => "select c.shareObjCode,sum(c.shareMoney) as shareMoney from oa_finance_payablesapply_cost c where 1=1 ",
	"count_group" => "select c.shareType,c.shareObjName,c.feeType,sum(c.shareMoney) as shareMoney from oa_finance_payablesapply_cost c where 1 "
);
