 ...
 * 销售开票申请策略
 */
class model_finance_invoiceapply_strategy_accessorder extends model_base implements iinvoiceapply{

	/************************页面渲染**********************/
	private $thisClass = 'model_service_accessorder_accessorder';
...
EOT;
	...
	function getObjInfo_d($obj){
		...
		$customerArr = $customerDao->get_d($innerObj['customerId']);
		$innerObj['customerType'] = $customerArr['TypeOne'];
		...
		//数组过滤,使数组能够通用载入
		//开票申请金额
		$innerObj['money']  = $innerObj['saleAmount'];
		unset($innerObj['saleAmount']);
        ...
        $innerObj['address']  = $innerObj['adress'];
		return $innerObj;
	}
