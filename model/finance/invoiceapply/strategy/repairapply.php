 ...
 * 销售开票申请策略
 */
class model_finance_invoiceapply_strategy_repairapply extends model_base implements iinvoiceapply{

	/************************页面渲染**********************/
	private $thisClass = 'model_service_repair_repairapply';
...
EOT;
	...
	function getObjInfo_d($obj){
		...
		//数组过滤,使数组能够通用载入
		//开票申请金额
		$innerObj['money']  = $innerObj['subCost'];
		unset($innerObj['subCost']);
