	...
	function show($mode=1,$url='')
	{
		switch ($mode)
		{
			...
			case '6':
				...
				$this->first_page='首页';
				$this->last_page='尾页';
				return $this->first_page()."&nbsp;&nbsp;".$this->pre_page()."&nbsp;&nbsp;".$this->next_page()."&nbsp;&nbsp;".$this->last_page()."&nbsp;&nbsp;".'第&nbsp;<font color=ff0000>'.$this->nowindex.'</font>/'.$this->totalpage."&nbsp;&nbsp;".'转到第'.$this->select().'页'."&nbsp;&nbsp;".'总共'.$this->total.'条';
				break;
		}
