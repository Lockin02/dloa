...
$msql->query( "select * from  templt_type  where 1 order by TYPE_ID" );
while ( $msql->next_record( ) )
{
    $ID = $msql->f( "TYPE_ID" );
    $DEPT_NAME = $msql->f( "TYPE_NAME" );
    echo "<tr class=\"TableControl\">\r\n  <td class=\"menulines\" align=\"center\" onclick=\"javascript:parent.user.location='user.php?DEPT_ID=";
    echo $ID;
    echo "&DEPT_NM=";
    echo $DEPT_NAME;
...
echo "<thead class=\"TableControl\">\r\n  <th bgcolor=\"#d6e7ef\" align=\"center\"><b>选择摸板类别</b></th>\r\n</thead>\r\n</table>\r\n</body>\r\n</html>\r\n";
?>
