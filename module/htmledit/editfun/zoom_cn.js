...
document.write('<div id="switchDiv" style="padding: 0;margin: 0;width: 100%"><table border="0" cellspacing="0" cellpadding="0" width="100%" style="background-color:#E3E3E3">');
document.write('<tr align="center"><td width="7%"><span id="status1" onClick="switchstatus(1)" style="font-size:12px; cursor:hand; background-color:#ffffff">普通</span></td><td width="7%"><span id="status2" onClick="switchstatus(2)" style="font-size:12px; cursor:hand">HTML</span></td><td width="7%"><span id="status3" onClick="switchstatus(3)" style="font-size:12px; cursor:hand">预览</td>');
document.write('<td><img src="../images/scrolll.gif" height=15 width=24></td><td width="75%" style="background-color:white;filter:Alpha(opacity=50);">&nbsp; </td><td><img src="/module/htmledit/images/scrollr.gif" height=15 width=24></td></tr></table></div>');

function switchstatus(flag){
	//document.frames.editor.frames.edit1.swapModes(flag);
   // document.frames.editor.swapModes(flag);
	var i;
	for(i = 1; i < 4; i ++) {
