...
<html>
 ...
 {
    ZS_VAL=parent_window.form1.ZS_ID.value;
   
     parent_window.form1.ZS_ID.value=user_id;
     parent_window.form1.ZS_NAME.value=user_name;
  window.close();
 }
 </script>
 </head>
...
<?php
$msql->query( "select * from xmsb_liucheng  where flag='2' order by ID" );
while ( $msql->next_record( ) )
{
    ...
    $ZS_USERS = $DEToNameVote['DEPT_NAME'].":".$ToNameVote['USER_NAME'];
