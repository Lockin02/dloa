...
if ( $rs )
{
    foreach ( $rs as $r )
    {
        echo "new Array(".strlen( $r[Depart_x] ) / 2.",'".$r[DEPT_NAME]."','".$r[Depart_x]."'),";
    }
}
