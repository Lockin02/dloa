...
class Graph
{
	...
	public $titlebackground_color = 'lightblue' , $titlebackground_style = 1 , $titlebackground_framecolor , $titlebackground_framestyle , $titlebackground_frameweight , $titlebackground_bevelheight;
	...
	public $iImgTrans = false , $iImgTransHorizon = 100 , $iImgTransSkewDist = 150 , $iImgTransDirection = 1 , $iImgTransMinSize = true , $iImgTransFillColor = 'white' , $iImgTransHighQ = false , $iImgTransBorder = false , $iImgTransHorizonPos = 0.5;
	public $legend;
	public $graph_theme;
	protected $iYAxisDeltaPos = 50;
	protected $iIconDepth = DEPTH_BACK;
	protected $iAxisLblBgType = 0 , $iXAxisLblBgFillColor = 'lightgray' , $iXAxisLblBgColor = 'black' , $iYAxisLblBgFillColor = 'lightgray' , $iYAxisLblBgColor = 'black';
	...
	function AddY ( $aN , $aPlot )
	{
		...
		if ( ( $cl instanceof Text ) || ( class_exists ( 'PlotLine' , false ) && ( $cl instanceof PlotLine ) ) || ( class_exists ( 'PlotBand' , false ) && ( $cl instanceof PlotBand ) ) )
		{
	...
	{
		$totrequired = ( $this -> title -> t != '' ? $this -> title -> GetTextHeight ( $this -> img ) + $this -> title -> margin + 5 * SUPERSAMPLING_SCALE : 0 ) + ( $this -> subtitle -> t != '' ? $this -> subtitle -> GetTextHeight ( $this -> img ) + $this -> subtitle -> margin + 5 * SUPERSAMPLING_SCALE : 0 ) + ( $this -> subsubtitle -> t != '' ? $this -> subsubtitle -> GetTextHeight ( $this -> img ) + $this -> subsubtitle -> margin + 5 * SUPERSAMPLING_SCALE : 0 );
...
class Grid
{
	...
	protected $fill = false , $fillcolor = array ( 
												'#EFEFEF' , 
												'#BBCCFF' 
	);
		...
		while ( $i < $nbr )
		{
			...
			if ( ( $i % $this -> label_step ) == 0 )
			{
				...
				} else
				{
					...
					if ( $this -> scale -> textscale && $this -> scale -> ticks -> label_formfunc == '' &&  ! $this -> scale -> ticks -> HaveManualLabels ( ) )
					{
...
class Ticks
{
	...
	public $maj_ticks_pos = array () , $maj_ticklabels_pos = array () , $ticks_pos = array () , $maj_ticks_label = array ();
	public $precision;
