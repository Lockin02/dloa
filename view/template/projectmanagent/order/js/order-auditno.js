			...
			[
			  {
					...
					menusEx : [
					{
					...
					},
						{
							...
							action : function(row,rows,grid){
								if(row){
									location = "controller/projectmanagent/order/ewf_index.php?actTo=ewfExam&orderId="+row.orderId+"&spid="+row.id+"&billId="+row.orderId+"&examCode=oa_sale_order&isTemp="+row.isTemp + "&skey="+row['skey_'];
								}
							}
						}
					],
