			...
			[
			  {
					...
					menusEx : [
					{
					...
					},
						{
							...
							action : function(row,rows,grid){
								if(row){
									location = "controller/projectmanagent/order/ewf_close.php?actTo=ewfExam&orderId="+row.orderId+"&spid="+row.id+"&billId="+row.orderId+"&examCode=oa_sale_order" + "&skey="+row['skey_'];
								}
							}
						}
					],
