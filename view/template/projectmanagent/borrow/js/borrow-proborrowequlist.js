var show_page = function(page) {
	$("#proborrowequGrid").yxsubgrid("reload");
};
$(function() {
	$("#proborrowequGrid").yxsubgrid({
		...
		subGridOptions : {
			...
			colModel : [
			{
				...
				process : function(v, row) {
					return '<a href="javascript:void(0)" onclick="javascript:showModalWin(\'?model=projectmanagent_borrow_borrow&action=proViewTab&id='
							+ row.id
