...
$(function () {
    ...
    for (var i = 1; i <= rowNum; i++) {
        getGoodsProducts(i, "?model=projectmanagent_borrow_borrowequ&action=getChangeConEqu&linkId=" + linkId);
    }
    $("#isShowDelCheckbox").click(function () {
        var checked = this.checked;
        var url = "?model=projectmanagent_borrow_borrowequ&action=toEquChangeView&&perm=view&linkId="
