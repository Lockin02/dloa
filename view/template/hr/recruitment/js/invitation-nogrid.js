	...
	$("#invitationGrid").yxgrid({
		...
		colModel : [{
			...
			process : function(v,row){
				return "<a href='#' onclick='showOpenWin(\"?model=hr_recruitment_invitation&action=toView&id="
					+ row.id + "&skey=" + row['skey_']
					+ "&placeValuesBeforeTB_=savedValues&TB_iframe=true&modal=false&height=400&width=800" +"\",1)'>" + v + "</a>";
			}
		},{
			name : 'parentCode',
			display : '源单编号',
