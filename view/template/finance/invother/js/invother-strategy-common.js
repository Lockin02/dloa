...
function initNumAndPrice(rowNum,thisType){
	...
	if((thisNumObj.val() == "" || parseInt(thisNumObj.val()) == 1) && thisType == 'allCount'){
		thisNumObj.val(1);
		thisTaxPriceObj.val(thisCountObj.val()).trigger('blur');

	}else if((thisNumObj.val() == "" || parseInt(thisNumObj.val()) == 1) && thisType == 'amount'){
		thisNumObj.val(1);
		thisPriceObj.val(thisAmountObj.val()).trigger('blur');
	}
}
