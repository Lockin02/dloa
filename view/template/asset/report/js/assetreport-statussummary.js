...
function search(){
	...
	location.href = "?model=asset_report_assetreport&action=toStatusSummary"
...
function OnContentCellDblClick(Sender){
	...
	var assetName = SelColumn.TitleCell.Text;
    var useStatusName = RunningDetailGrid.Recordset.Fields.Item("资产状态").AsString;
	showModalWin("?model=asset_report_assetreport&action=toDetail"
		+ "&beginDate=" + $("#beginDate").val()
		+ "&endDate=" + $("#endDate").val()
		+ "&company=" + $("#company").val()
		+ "&deptId=" +  $("#deptId").val()
