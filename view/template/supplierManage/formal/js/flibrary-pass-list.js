...
var show_page = function(page) {
	$("#flibraryPassGrid").yxgrid("reload");
};
$(function() {
			$("#flibraryPassGrid").yxgrid({
...
//												success : function(msg) {
//													if (msg == 1) {
//														location="?model=supplierManage_assessment_supasses&action=toQuarterAss&assesType=gysjd&suppId="+row.id;
//													}else {
//														alert('该供应商已进行季度考核!');
//													}
//												}
...
//												success : function(msg) {
//													if (msg == 1) {
//														location="?model=supplierManage_assessment_supasses&action=toQuarterAss&assesType=gysnd&suppId="+row.id;
//													}else {
//														alert('该供应商已进行年度考核!');
//													}
//												}
									...
									action : function(row) {
										if(row){
											$.ajax({
												...
												success : function(msg) {
													if (1) {
														showThickboxWin("?model=supplierManage_assessment_task&action=toAddBySupp&assesType=gysjd&suppId="+row.id
									...
									action : function(row) {
										if(row){
											$.ajax({
												...
												success : function(msg) {
													if ( 1) {
														showThickboxWin("?model=supplierManage_assessment_task&action=toAddBySupp&assesType=gysnd&suppId="+row.id
																		+ "&perm=view&placeValuesBefore&TB_iframe=true&modal=false&height="
																		+ 400 + "&width=" + 800);
													}else {
														alert('该供应商已下达考核任务!');
