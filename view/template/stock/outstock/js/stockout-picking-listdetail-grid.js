...
$(function() {
	...
	$("#stockoutGrid").yxgrid({
		...
		action : 'calPageJson',
		title : "领料成本明细表: " + '财务期 : ' + $("#beginYear").val() + '.' + $("#beginMonth").val() + ' 至  ' + $("#endYear").val() + '.' + $("#endMonth").val() + productCode + deptName + pickName ,
		isAddAction : false,
		isViewAction : false,
		isEditAction : false,
		isDelAction : false,
		...
		buttonsEx : [
			...
			action : function(row) {
				...
				window.open("?model=stock_outstock_stockout&action=outExportExcel&colId="
