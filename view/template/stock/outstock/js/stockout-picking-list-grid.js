...
$(function () {
    $("#stockoutGrid").yxsubgrid({
        ...
        toAddConfig: {
            toAddFn: function (p) {
                showModalWin("?model=stock_outstock_stockout&action=toAdd&docType=CKPICKING")
            }
        },
        comboEx: [{
            text: '单据状态',
        ...
        buttonsEx: [{
            ...
            icon: 'search',
            action: function (row) {
                showThickboxWin("?model=stock_outstock_stockout&action=toAdvancedSearch&docType=CKPICKING"
