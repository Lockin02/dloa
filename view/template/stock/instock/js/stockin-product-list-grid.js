...
$(function () {
    $("#purhasestorageGrid").yxsubgrid({
        ...
        toAddConfig: {
            toAddFn: function (p) {
                action : showModalWin("?model=stock_instock_stockin&action=toAdd&docType=RKPRODUCT")
            }
        },
        buttonsEx: [
            {
                ...
                icon: 'search',
                action: function (row) {
                    showThickboxWin("?model=stock_instock_stockin&action=toAdvancedSearch&docType=RKPRODUCT"
