...
function subTotalPrice1(el) {// 计算物料金额
	...
	if (proNumVal >= 0) {
		$(el).parent().next().next().children().eq(0).val($(el).val() * proNumVal);
	}
}
