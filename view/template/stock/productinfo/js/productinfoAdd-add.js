$(document).ready(function() {
	...
	$("#submitSave").click(function(){
		$("#form1").attr("action","?model=stock_productinfo_productinfoAdd&action=add");
	});
	$("#submitStatus").click(function(){
		$("#form1").attr("action","?model=stock_productinfo_productinfoAdd&action=addSubmit");
	...
	$("#productCode").ajaxCheck({
		url : "?model=stock_productinfo_productinfoAdd&action=checkRepeat",
		alertText : "* 该编码已存在",
		alertTextOk : "* 该编码可用"
	});
	$("#productCode").focus();
