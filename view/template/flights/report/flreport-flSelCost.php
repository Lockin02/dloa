...
select
	...
	c.projectCode,c.chanceCode,c.province as province,
	c.costBelonger as costBelonger,
...
where year(b.balanceDateB) = $year and c.detailType = 4 $condition
GROUP BY c.costBelongDeptId,c.projectCode,c.chanceCode,c.province,c.costBelonger;
QuerySQL;
