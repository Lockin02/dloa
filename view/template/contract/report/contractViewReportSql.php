...
select year,areaPrincipal,province,customerTypeName,0 as ordnum,type,if(type='金额',"全国","") as typeName,1 as gradeNum,0 as num,
   sum(Q1_100) as Q1_100,sum(Q1_50) as Q1_50,sum(Q1_0) as Q1_0,sum(Q1_c) as Q1_c,
   sum(Q2_100) as Q2_100,sum(Q2_50) as Q2_50,sum(Q2_0) as Q2_0,sum(Q2_c) as Q2_c,
   sum(Q3_100) as Q3_100,sum(Q3_50) as Q3_50,sum(Q3_0) as Q3_0,sum(Q3_c) as Q3_c,
   sum(Q4_100) as Q4_100,sum(Q4_50) as Q4_50,sum(Q4_0) as Q4_0,sum(Q4_c) as Q4_c,
   sum(all_100) as all_100,sum(all_50) as all_50,sum(all_0) as all_0,sum(all_c) as all_c
 from oa_contract_view $whereSql GROUP BY type
...
select year,areaPrincipal,province,customerTypeName,0 as ordnum,type,if(type='金额',"移动+第三方","") as typeName,1 as gradeNum,1 as num,
   ...
   sum(Q4_100) as Q4_100,sum(Q4_50) as Q4_50,sum(Q4_0) as Q4_0,sum(Q4_c) as Q4_c,
   sum(all_100) as all_100,sum(all_50) as all_50,sum(all_0) as all_0,sum(all_c) as all_c
 from oa_contract_view where (customerTypeName = '移动' or customerTypeName = '运营商-移动集团' or customerTypeName = '第三方' or customerTypeName = '移动+第三方') $sql  GROUP BY type
...
select year,areaPrincipal,province,customerTypeName,0 as ordnum,type,if(type='金额',"联通","") as typeName,1 as gradeNum,1 as num,
   ...
   sum(Q4_100) as Q4_100,sum(Q4_50) as Q4_50,sum(Q4_0) as Q4_0,sum(Q4_c) as Q4_c,
   sum(all_100) as all_100,sum(all_50) as all_50,sum(all_0) as all_0,sum(all_c) as all_c
 from oa_contract_view where (customerTypeName = '联通' or customerTypeName = '运营商-联通集团') $sql  GROUP BY type
...
select year,areaPrincipal,province,customerTypeName,0 as ordnum,type,if(type='金额',"电信","") as typeName,1 as gradeNum,1 as num,
   ...
   sum(Q4_100) as Q4_100,sum(Q4_50) as Q4_50,sum(Q4_0) as Q4_0,sum(Q4_c) as Q4_c,
   sum(all_100) as all_100,sum(all_50) as all_50,sum(all_0) as all_0,sum(all_c) as all_c
 from oa_contract_view where (customerTypeName = '电信' or customerTypeName = '运营商-电信集团') $sql  GROUP BY type
...
select year,areaPrincipal,province,customerTypeName,0 as ordnum,type,if(type='金额',"系统商","") as typeName,1 as gradeNum,1 as num,
   ...
   sum(Q4_100) as Q4_100,sum(Q4_50) as Q4_50,sum(Q4_0) as Q4_0,sum(Q4_c) as Q4_c,
   sum(all_100) as all_100,sum(all_50) as all_50,sum(all_0) as all_0,sum(all_c) as all_c
 from oa_contract_view where customerTypeName = '系统商' $sql GROUP BY type
