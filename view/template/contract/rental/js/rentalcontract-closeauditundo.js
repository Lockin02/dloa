			...
			width : 90
					...
					menusEx : [
					{
					...
					},
						{
							...
							action : function(row,rows,grid){
								if(row){
									location = "controller/contract/rental/ewf_close.php?actTo=ewfExam&orderId="+row.contractId+"&spid="+row.id+"&billId="+row.contractId+"&examCode=oa_sale_service" + "&skey="+row['skey_'];
								}
							}
						}
					],
