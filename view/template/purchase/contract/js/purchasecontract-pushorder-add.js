$(function() {
		validate({
 		...
 		if (selectRemark==''){
 			$("#selectRemark").val('1、订单总金额超过5000，需要至少2家以上的报价。如不能提供，请说明缘由。2、请做简单价格分析。3、请说明选择这家供应商下订单的理由。');
...
function checkSumbit(){
			...
			if( selectRemark=='1、订单总金额超过5000，需要至少2家以上的报价。如不能提供，请说明缘由。2、请做简单价格分析。3、请说明选择这家供应商下订单的理由。' || selectRemark=="" ){
				alert("1、订单总金额超过5000，需要至少2家以上的报价。如不能提供，请说明缘由。2、请做简单价格分析。3、请说明选择这家供应商下订单的理由。");
				return false;
			}
