...
//			},
			...
			event : {
				blur : function() {
					...
					var rowNum = $(this).data("rowNum");
					var g = $(this).data("grid");
					var planBeginDate = g.getCmpByRowAndCol(rowNum,'planBeginDate').attr('id');
					var planEndDate = g.getCmpByRowAndCol(rowNum,'planEndDate').attr('id');
					//验证日期是否超期
					var isOverDay = periodCheck(planBeginDate,planEndDate,$(this).attr('id'));
