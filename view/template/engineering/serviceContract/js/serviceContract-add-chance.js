...
function ToApp(){
	document.getElementById('form1').action = "index1.php?model=engineering_serviceContract_serviceContract&action=addChance&act=app";
}
//汇率计算
$(function conversion(){
								...
								$("#isCon" + i).val("isCon_" + i);
								       $.get('index1.php', {
											...
											if (pro) {
												...
												document.getElementById("prodcutNumber").value = document.getElementById("productNumber").value * 1 + 1;
												recount("invbody");
											} else {
											}
										})
