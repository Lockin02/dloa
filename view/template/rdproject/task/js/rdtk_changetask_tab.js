var plus = "&varName=mtkTabInfo&jsUrl=view/template/rdproject/task/js/rdtk_changetask_tab.js&objTable=oa_rd_task&objId=";
var jsUrl="view/template/rdproject/task/js/rdtk_changetask_tab.js";
var mtkTabInfo = [{
		"name":"基本信息",
		"url"  : "?model=rdproject_task_rdtask&action=toChangeTask&id=",
		"choose" : "1"
	},{
		"name":"前置任务详细",
