...
function mydel(obj, mytable, orderArray) {
	if (confirm('确定要删除该行？')) {
		...
		$row.append("<input type='hiden' name='rdproject["+ orderArray +"]["+ rowNo +"][isDel]' value='1'>");
		$row.hide();
...
//	oTL0.innerHTML = i;
//	 oTL1 = oTR.insertCell([1]);
//     oTL1.innerHTML = "<input type='text' size='55' name='rdproject[rdprojectequ]["+ mycount +"][serviceItem]' id='serviceItem"+ mycount +"'>";
//     oTL2 = oTR.insertCell([2]);
//     oTL2.innerHTML = "<input type='text' class='txt' name='rdproject[rdprojectequ]["+ mycount +"][number]' id='number"+ mycount +"'>";
//     oTL3 = oTR.insertCell([3]);
//     oTL3.innerHTML = "<input type='text' size='45' name='rdproject[rdprojectequ]["+ mycount +"][remark]' id='remark"+ mycount +"'> ";
//     oTL4 = oTR.insertCell([4]);
//     oTL4.innerHTML = "<input type='hidden' id='LicenseId" + mycount + "' name='rdproject[rdprojectequ][" + mycount + "][license]'/>" +
...
function dynamic_add(packinglist, countNumP) {
	...
	oTL1.innerHTML = "<input type='text' id='productNo" + mycount + "' class='txtshort' name='rdproject[rdprojectequ][" + mycount + "][productNo]' readonly>"+
	...
	oTL3.innerHTML = "<input id='productModel" + mycount + "' type='text' class='readOnlyTxtItem' name='rdproject[rdprojectequ][" + mycount + "][productModel]' readonly>";

    var oTL4 = oTR.insertCell([4]);
	oTL4.innerHTML = "<input class='txtshort' type='text' name='rdproject[rdprojectequ][" + mycount + "][number]' id='number" + mycount + "' onblur='FloatMul(\"number" + mycount + "\",\"price" + mycount + "\",\"money" + mycount
			+ "\")' />";
	var oTL5 = oTR.insertCell([5]);
	oTL5.innerHTML = "<input class='txtshort' type='text' name='rdproject[rdprojectequ][" + mycount + "][price]' id='price" + mycount + "' onblur='FloatMul(\"number" + mycount + "\",\"price" + mycount + "\",\"money" + mycount + "\")' />";
