...
var show_page = function(page) {
	$(".rdprojectListYwcGrid").yxgrid("reload");
};
$(function() {
	$(".rdprojectListYwcGrid").yxgrid({
...
//			},
			...
			action : function(row) {
				location = '?model=rdproject_yxrdproject_rdproject&action=toChange&changer=changer&changeC=changeC&id='
						+ row.id + "&skey=" + row['skey_'];
			}
		}, {
