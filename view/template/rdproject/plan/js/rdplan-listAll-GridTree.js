...
function newProjectTreeGrid() {
	...
	var content = {
		...
		dataUrl : "?model=rdproject_project_rdproject&action=rpAjaxAllPlan",
		lazyLoadUrl : "?model=rdproject_plan_rdplan&action=rpAjaxAllPlan",
		...
		hidddenProperties : ['name', 'projectId', 'projectName','projectCode', 'planName','purviewKey'],// 用于隐藏在一行中的属性,适合传递值的一种方式.
		iconShowIndex : 3,
		contextMenu : {
			// width : 150,
			// alias:"1-1",
