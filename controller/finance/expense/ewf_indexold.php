...
if($actTo=="ewfSelect"){
    ...
    $disPassSqlCode=isset($disPassSqlCode)?$disPassSqlCode:"update cost_summary_list set ExaStatus = '打回',Status = '打回',ExaDT = now() where id='$billId'";//审批打回更新语句
    //特殊审批角色： 项目经理 -- 区域经理
...
if($actTo=="ewfBuild"){
    ...
    $sendToURL="../../../index1.php?model=finance_expense_expense&action=toSubOldExpense&id=$billId";//生成工作流后跳转的页面
