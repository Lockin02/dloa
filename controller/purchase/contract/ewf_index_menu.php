...
//    $sendToURL="../../../index1.php?model=rdproject_project_rdproject&action=rpRead&pjId=".$billId;//生成工作流后跳转的页面
	$sendToURL="../../../index1.php?model=purchase_contract_purchasecontract&action=toAddOrder";//生成工作流后跳转的页面
...
if($actTo=="ewfExam"){
    ...
    $billId=isset($billId)?$billId:"";//审批表单数据ID
    $detailUrl=isset($detailUrl)?$detailUrl:"../../../index1.php?model=purchase_contract_purchasecontract&action=toViewVontract&pjId=$billId&readType=exam";//审批查看内容
