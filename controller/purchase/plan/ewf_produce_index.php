...
if($actTo=="ewfExam"){
    ...
    $billId=isset($billId)?$billId:"";//审批表单数据ID
	$detailUrl=isset($detailUrl)?$detailUrl:"../../../index1.php?model=purchase_plan_basic&action=read&purchType=produce&actType=audit&id=$billId&skey=$skey";//审批查看内容
...
if($actTo=="delWork"){
    ...
    $formName=isset($formName)?$formName:"生产采购申请审批";//工作流表单名称
