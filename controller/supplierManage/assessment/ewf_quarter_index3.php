...
if($actTo=="ewfSelect"){
    ...
    $disPassSqlCode=isset($disPassSqlCode)?$disPassSqlCode:" update oa_supp_suppasses set ExaStatus = '打回' where id='$billId'";//审批打回更新语句
    //特殊审批角色： 项目经理 -- 区域经理
...
if($actTo=="ewfBuild"){
    //$sendToURL=$baseDir."?actTo=swfList";
     $msql->query(" update oa_supp_suppasses SET ExaStatus='部门审批' where id='$billId' ");
    $sendToURL="../../../index1.php?model=supplierManage_formal_flibrary&action=toPassSupplist";//生成工作流后跳转的页面
