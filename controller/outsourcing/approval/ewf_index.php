...
if($actTo=="ewfSelect"){
    ...
    $disPassSqlCode=isset($disPassSqlCode)?$disPassSqlCode:" update oa_outsourcing_approval a left join oa_outsourcing_apply c on(a.applyId=c.id) set c.state=1, a.ExaStatus = '打回' where a.id='$billId'";//审批打回更新语句
    //特殊审批角色： 项目经理 -- 区域经理
    ...
    //变量定义
    $formName=isset($formName)?$formName:"外包立项审批";//工作流表单名称
