...
if($actTo=="ewfSelect"){
    ...
    $passSqlCode=isset($passSqlCode)?$passSqlCode:" update oa_esm_project set ExaStatus = '完成',status = 'GCXMZT02',statusName = '在建',ExaDT = now() where id='$billId' ";//审批完成后更新语句
    ...
    //变量定义
    $formName=isset($formName)?$formName:"工程项目审批";//工作流表单名称
