...
if($actTo=="ewfSelect"){
    ...
    $passSqlCode=isset($passSqlCode)?$passSqlCode:"update oa_sale_service set ExaStatus='完成',signIn = '0' where id='$billId'";//审批完成后更新语句
...
if($actTo=="ewfBuild"){
   ...
   $sendToURL="../../../index1.php?model=engineering_serviceContract_serviceContract&action=toMyorderYwc";//生成工作流后跳转的页面
