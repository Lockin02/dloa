...
if($actTo=="ewfSelect"){
    ...
    //变量定义
    $formName=isset($formName)?$formName:"新合同物料确认审批";//工作流表单名称
...
//生成工作流
if($actTo=="ewfBuild"){
	$msql->query(" update oa_contract_equ_link SET ExaStatus='部门审批' where id='$billId' ");//提交审批后改变审批状态
...
//提交审批工作流
if($actTo=="ewfExamSub"){
    $sendToURL="../../../index1.php?model=contract_contract_contract&action=shipments";//处理审批后跳转的页面
