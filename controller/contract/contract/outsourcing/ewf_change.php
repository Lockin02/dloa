...
if($actTo=="ewfSelect"){
    ...
    //变量定义
    $formName=isset($formName)?$formName:"外包合同变更审批";//工作流表单名称
...
if($actTo=="ewfBuild"){
	...
	$msql->query(" update oa_sale_outsourcing o1 left join oa_sale_outsourcing o2 on o1.id=o2.originalId SET o1.ExaStatus='变更审批中',o1.status = 4 where o2.id ='$billId'");//更改原来单据为变更审批中状态
