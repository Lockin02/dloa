...
if($actTo=="ewfSelect"){
    ...
    $passSqlCode=isset($passSqlCode)?$passSqlCode:"update oa_sale_lease set ExaStatus='完成',signIn = '0' where id='$billId'";//审批完成后更新语句
...
if($actTo=="ewfBuild"){
    ...
    $sendToURL="../../../index1.php?model=contract_rental_rentalcontract&action=toListYwc";//生成工作流后跳转的页面
...
if($actTo=="ewfExam"){
    ...
    $billId=isset($billId)?$billId:"";//审批表单数据ID
    $detailUrl=isset($detailUrl)?$detailUrl:"../../../index1.php?model=contract_rental_rentalcontract&action=init&perm=view&id=$billId";//审批查看内容
