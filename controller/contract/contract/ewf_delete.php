...
if($actTo=="ewfSelect"){
    ...
    $passSqlCode=isset($passSqlCode)?$passSqlCode:"delete from oa_contract_contract where id='$billId'";//审批完成后更新语句
...
//    $billDept=isset($billDept)?$billDept:$DEPT_ID;//审批表单数据所属部门 -- 区域经理
    ...
    //变量定义
    $formName=isset($formName)?$formName:"合同删除审批";//工作流表单名称
...
//生成工作流
if($actTo=="ewfBuild"){
	$sendToURL="../../../index1.php?model=contract_contract_contract&action=mycontract";//生成工作流后跳转的页面
