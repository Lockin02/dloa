...
if($actTo=="ewfExam"){
    ...
    $billId=isset($billId)?$billId:"";//审批表单数据ID
    $detailUrl=isset($detailUrl)?$detailUrl:"../../../index1.php?model=common_workflow_workflow&action=toObjInfo&taskId=$taskId&spid=$spid&billId=$billId&formName=$formName&code=$code&isTemp=$isTemp";//审批查看内容
...
if($actTo=="ewfExamSub"){
    ...
    $sendToURL="../../../index1.php?model=common_workflow_workflow&action=toLoca&spid=$spid" . $addStr ;//处理审批后跳转的页面
